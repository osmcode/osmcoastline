...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        osmium::TypedMemoryMapping<osmium::UndirectedSegment> m1{file1.size() / sizeof(osmium::UndirectedSegment), osmium::MemoryMapping::mapping_mode::readonly, file1.fd()};
        osmium::TypedMemoryMapping<osmium::UndirectedSegment> m2{file2.size() / sizeof(osmium::UndirectedSegment), osmium::MemoryMapping::mapping_mode::readonly, file2.fd()};
